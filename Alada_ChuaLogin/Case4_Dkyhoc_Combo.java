...
public class Case4_Dkyhoc_Combo extends commonbase {
    @BeforeMethod
    ...
    @Test (priority = 1)
    public void Khoahocnoibat() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
        WebElement Khoahocnoibat = findVisibleElement(AladaLocator.KhoahocNoibat);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", Khoahocnoibat);
        Khoahocnoibat.click();
    ...
    @Test (priority = 2)
    public void Khoahocvuaramat() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 3)
    public void KhuyenMaiHot() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 4)
    public void CNTT() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 5)
    public void Mar() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 6)
    public void Kinhdoanh() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 7)
    public void Kynangmem() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 8)
    public void Chamsoc() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 9)
    public void TiengAnh() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
    ...
    @Test (priority = 10)
    public void BiQuyet() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
