...
public class BepAnToan_GiaThap extends commonbase{
    @BeforeMethod
    public void openBrowser() {
        initDriverWithZoom();  // khởi tạo driver với zoom 80%
    }
    @Test
    public void verifyGiaThap() throws InterruptedException {
        ...
        //cho gia thap hien thi de click
        WebElement GiaThap = wait.until(ExpectedConditions.elementToBeClickable(BepAnToanLocator.GiaThap));
        Thread.sleep(5000);
        ...
        for (WebElement priceEl : priceElements) {
            ...
            try {
                ...
                if (price < 2000000) {
                    System.out.println("Có sản phẩm giá thấp: " + priceText);
        ...
        Assert.assertTrue(foundProductGiaThap,"Không có sản phẩm nào giá thấp");
    }
}
